...
class ProfileSettings extends API {
    ...
    removeAvatar = async function() {
        return this.wrapContent('none', this.#instance.delete('/settings/profile/background')).then(_ => this)
    }
    ...
    removeBackground = async function() {
        return this.wrapContent('none', this.#instance.delete('/settings/profile/avatar')).then(_ => this)
    }
}
