...
class ProfileSettings extends API {
    ...
    update = async function({
        ...
        return this.wrapContent('none', this.#instance.put('/settings/profile', data)).then(_ => {
    ...
    removeAvatar = async function() {
        return this.wrapContent('none', this.#instance.delete('/settings/profile/background')).then(_ => { return this })
    }
    ...
    removeBackground = async function() {
        return this.wrapContent('none', this.#instance.delete('/settings/profile/avatar')).then(_ => { return this })
    }
}
