...
class AccountSettings extends API {
    ...
    get = async function() {
    	return this.wrapContent('account_settings', await this.#instance.get('/settings/general'));
    }

    update = async function(update) {
    	return this.#core, await this.#instance.put('/settings/general', {
    		data: update
...
class ProfileSettings extends API {
    ...
    get = async function() {
        return this.wrapContent('profile_settings', await this.#instance.get('/profile'));
    }
    ...
    update = async function({
        ...
        return await this.#instance.put('/settings/profile', data).then(_ => {
            return this.wrapContent('profile_settings', data)
        })
    }

    submitAvatar = async function(key) {
        return await this.#instance.post('/settings/profile/avatar', {
            data: {
                avatar: key
            }
        }).then(_ => { return this })
    ...
    removeAvatar = async function() {
        return await this.#instance.delete('/settings/profile/background').then(_ => { return this })
    }

    submitBackground = async function(key) {
        return await this.#instance.post('/settings/profile/background', {
            data: {
                avatar: key
            }
        }).then(_ => { return this })
    ...
    removeBackground = async function() {
        return await this.#instance.delete('/settings/profile/avatar').then(_ => { return this })
    }
}
