...
export default class Link extends API {
    ...
    addComment = function({ id = this.id, commentId = null, content = null, photo = null, embed = null, adult = false } = {}) {
        assert(id, this.#errors.assert.notSpecified('id'));
    ...
    addRelatedLink = function({ id = this.id, title = null, url = null, adult = false } = {}) {
        assert(id, this.#errors.assert.notSpecified('id'));
