...
const proxymise = (target) => {
	...
	return typeof target === 'function' && !target.__proxy__ && !Object.keys(target).includes('__proxy__') ? new Proxy(target, handler) : target;
};
...
const handler = {
	...
	get(target, property, receiver) {
		...
		if (target[property] === null) { return null; }
